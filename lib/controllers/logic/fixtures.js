...
exports.generateLeagueFixturesLogic = function ({tournamentId: _id, user: admin}) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (!everyTeamHasAName(teams)) return reject(128);
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (currentRound) {
                ...
                tournament.startingRound = newRound;
...
function sortLeagueTableData (tableData) {
    tableData.sort((a, b) => {
        ...
        if (aPoints === bPoints) {
            // sorting goes from biggest to smallest
            ...
            if (a.teamDetails.teamName > b.teamDetails.teamName) return 1
            else if (a.teamDetails.teamName < b.teamDetails.teamName) return -1
            return 0
        }
