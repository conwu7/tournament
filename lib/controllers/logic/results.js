...
exports.addKnockoutResultLogic = function ({tournamentId: _id, results, user: admin}) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const {isKnockout, useTwoLegs, useAwayGoals, isComplete, currentRound} = fixtures;
            ...
            results.forEach((result, index) => {
                ...
                if (useTwoLegs) {
                    ...
                    if (result && awayResult) {
                        const outcome = winLossTieKnockout(homeFor, homeAgainst, awayFor, awayAgainst, useAwayGoals);
...
* */
function winLossTieKnockout (homeFor, homeAgainst, awayFor, awayAgainst, useAwayGoals) {
